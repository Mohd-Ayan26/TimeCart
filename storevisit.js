...
document.getElementById('appointmentForm').addEventListener('submit', async function(e) {
    ...
    loadingSpinner.innerHTML = `
        ...
        <p style="margin-top: 20px; color: #4CAF50;">Processing your appointment...</p>
    `;
        ...
        const confirmationHtml = `
            <div class="confirmation-page">
                <div class="confirmation-header">
                    ...
                    <p>Thank you for choosing our service. Your appointment details are below:</p>
                ...
                <div class="confirmation-details">
                    ...
                    <div class="detail-group">
                        <h3><i class="fas fa-store"></i> Appointment Details</h3>
                    ...
                    <div class="confirmation-footer">
                        <p><i class="fas fa-info-circle"></i> Please arrive 10 minutes before your appointment time.</p>
